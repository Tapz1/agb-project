...
from flaskr.project_controller import view_all_projects, view_project, delete_project, view_project_by_id
...
blueprint.route('/gallery/view-project/<string:project_id>', methods=['POST'])(view_project_by_id)
