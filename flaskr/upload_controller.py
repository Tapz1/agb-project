    ...
    try:
        ...
        if uploaded_images:
            ...
            if isNew:
                ...
                try:
                    pathlib.Path(current_app.app_context().app.config['UPLOAD_FOLDER'], project_name).mkdir(
                        exist_ok=False)
                ...
                try:
                    project_path = os.path.join(current_app.app_context().app.config['UPLOAD_FOLDER'], project_name)
